                        ...
                        <div className="footer-box">
                            <div className="">
                                ...
                                <div className="cont-numbers">
                                    <p><strong>Call: </strong><a href="tel:+971800700600">+971 800700600</a></p>
                                    <p><strong>Whatsapp: </strong><a href="//api.whatsapp.com/send?phone=+971800700600">+971 800700600</a></p>
                                    <p><strong>Whatsapp: </strong><a href="//api.whatsapp.com/send?phone=+971800700600">+971 800700600</a></p>
                                </div>
                            ...
                            <div className="">
                                <div className="footlogo">
                                    <div >
                                        ...
                                        <li><Link>Purchasing Policy </Link> </li>
                            ...
                            <div className="">
                                ...
                                <div className="foot-email-box">
                                    <form>
                                    <input type="" placeholder="Your email address" className="email-input" />
