                    ...
                    <div className="card-body">
                      <form className="pb-3">
                        <div className="input-group">
                          <input
                            type="text"
                            className="form-control form-search-list"
                            placeholder="Search"
                          />
                          <div className="input-group-append">
                            <button
                              className="btn btn-light find-btn"
                              type="button"
                            >
                              <i className="fa fa-search"></i>
                            </button>
                  ...
                  <div className="filter-content collapse show" id="collapse_2">
                    <div className="card-body">
                      <label className="custom-control custom-checkbox">
                        ...
                        />
                        <div className="custom-control-label custom-control-check">
                          Mercedes
                    ...
                    <div className="card-body">
                      ...
                      <div className="form-row">
                        <div className="form-group col-md-6">
                          <label>Min</label>
                          <input
                            className="form-control form-price-wid"
                            placeholder="$0"
                            type="number"
                          />
                        </div>
                      ...
                      <button className="btn btn-block btn-primary btn-cart">
                        Apply
                      </button>
                    </div>
                  </div>
              ...
              <header className="border-bottom mb-4 pb-3">
                <div className="form-inline">
                  ...
                  <div className="btn-group">
                    <a
                      href="#"
                      className="btn btn-outline-secondary btn-list"
                      data-toggle="tooltip"
                      title="List view"
                    >
                    ...
                    <a
                      href="#"
                      className="btn  btn-outline-secondary btn-grid active"
                      data-toggle="tooltip"
                      title="Grid view"
                    >
                ...
                <div className="col-md-4">
                  <figure className="card card-product-grid">
                    <div className="img-wrap">
                      <span className="badge badge-danger badge-btn">
                        {" "}
                        NEW{" "}
                      </span>
                      <img src="assets/images/items/1.jpg" />
                      <a className="btn-overlay quick-view-btn" href="#">
                    ...
                    <figcaption className="info-wrap">
                      ...
                      <a
                        href="#"
                        className="btn btn-block btn-primary btn-cart"
                      >
                        Add to cart{" "}
                      </a>
                    </figcaption>
              ...
              <nav className="mt-4" aria-label="Page navigation sample">
                <ul className="pagination page-center d-flex align-items-center justify-content-center">
                  ...
                  <li className="page-item active">
                    <a className="page-link page-view-link" href="#">
                      1
                    </a>
                  </li>
